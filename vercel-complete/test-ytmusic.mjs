// Test script untuk YouTube Music API menggunakan ES modules
...
async function testYTMusicAPI() {
  ...
  try {
    ...
    const searchResults = await ytmusic.searchSongs('Pamungkas To the Bone', { limit: 3 });
    ...
    const indonesianTracks = await ytmusic.searchSongs('trending indonesia', { limit: 2 });
